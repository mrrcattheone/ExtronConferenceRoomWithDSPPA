...
NaviGroup = [
    BtnImageSettings,
    BtnTVSettings,
    BtnCamControlSettings,
    BtnMicControlSettings,
    PowerControlSettings,
    BtnMainMenuPowerOn,
    back_from_conn_page_btn,
    BtnMainMenuTVControl,
    BtnMainMenuImageControl,
    backFromModeBtn,
    BtnSimpleConferenceModMenu,
    BtnSimpleConferenceModMenu2,
    BtnExpertMode,
    BtnMainMenuImage_1Control,
    back_to_main_btn,
    BtnMainMenuMicControl,
    connection_page_btn,
]
...
# MicControlGroup
mic_off_group = [
    mic_off_conference_1,
    mic_off_conference_2,
    mic_off_conference_3,
    mic_off_conference_without_leader,
]
...
image_control_group = [
    ...
    videoWallBtn6,
    videoWallBtn7,
    tableSplitterVideoBtn1,
    tableSplitterVideoBtn2,
    tableSplitterVideoBtn3,
    tableSplitterVideoBtn4,
    speakerVideoBtn1,
    speakerVideoBtn2,
    speakerVideoBtn3,
    speakerVideoBtn4,
...
def ButtonObjectPressed(button, state):
    if state == "Pressed":
        button_actions = {
            ...
            183: {
                "pages": ["PageModeSelection"],
                "message": "Page Easy Conference Open",
            },
            154: {
                "pages": ["PageModeSelection"],
                "message": "Page Easy Conference Open",
            ...
            179: {
                "pages": ["PageModeSelection_1"],
                "message": "Page Presentation Open",
            },
            153: {
                "pages": ["PageModeSelection_2"],
                "message": "Page Videoconference Open",
            },
            ...
            194: {
                "pages": ["PageConnectionCheck"],
                "message": "PageConnectionCheck Open",
            },
        }
